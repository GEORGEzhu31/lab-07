...
```{r viz-score}
# 
ggplot(evals, mapping = aes(x = score)) + geom_histogram(binwith = 0.1)
summary(evals$score)
```

*The shape of the histogram is negative skewed. Students usually give a high score, since the mean score is 4.175. It's what we expected to see, because it proves most courses are high quality*
